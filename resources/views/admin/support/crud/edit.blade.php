    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-default">
                ...
                <div class="card-body">
                    {!! Form::model($support[0], ['method' => 'PATCH', 'route' => ['support.update', $support[0]->support_supportid], 'disabled' => true]) !!}
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{ Form::select('client_id', $clients, null, $errors->has('client_id') ? ['disabled' => 'disabled', 'placeholder' => 'Please select ...', 'class' => 'form-control is-invalid'] : ['disabled' => 'disabled','placeholder' => 'Please select ...', 'class' => 'form-control']) }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{ Form::text('project_url', null, $errors->has('project_url') ? ['disabled' => 'disabled', 'placeholder' => 'Project URL', 'class' => 'form-control is-invalid'] : ['disabled' => 'disabled','placeholder' => 'Project URL', 'class' => 'form-control']) }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('due_date', "$cycle_date1", array('name' => 'due_date', 'placeholder' => 'Cycle Date', 'class' => 'form-control', 'id' => 'datepicker-end', 'disabled' => 'enable')) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {!! Form::textarea('access_data', null, array('placeholder' => 'Access_data','size' => '30x5', 'class' => 'form-control', 'id' => 'access_data')) !!}
